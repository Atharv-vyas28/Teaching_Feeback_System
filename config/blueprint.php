...
return [
    ...
    */
    ...
    | them with daisyUI (the default Blueprint views are unstyled scaffolding and
    | would collide with the agent's pages). Backend (models/migrations/factories/
    | requests/routes/controllers) by Blueprint; views by the agent. Mirrors the
    | react stack disabling `inertia_page`. See infra/../STAGE_A_CONTRACT.md.
    |
    */
    'generators' => [
        ...
        // 'view' => \Blueprint\Generators\Statements\ViewGenerator::class, // disabled — agent owns daisyUI views
