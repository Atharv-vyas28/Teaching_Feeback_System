...
<a href="{{ route('staff.attendance.history') }}" class="nav-link active">Attendance History</a>
...
<div class="card" style="margin-bottom:24px;">
    ...
    <form method="GET" action="{{ route('staff.attendance.history') }}" style="display:flex;gap:12px;flex-wrap:wrap;align-items:flex-end;">
        <div>
        ...
        <div>
            ...
            @if(request()->hasAny(['section_id','date_from','date_to','search']))
                <a href="{{ route('staff.attendance.history') }}" class="btn-secondary" style="height:38px;display:inline-flex;align-items:center;">Clear</a>
            @endif
        </div>
    </form>
</div>
