...
<div class="attendance-hero">
    <div class="attendance-hero-top">
        <div>
            ...
            <p>
                <?php echo e($classSession->topic ?? 'No topic specified for this session.'); ?>
    ...
    <div class="session-details">
        <div class="session-detail-card">
            ...
            <div class="session-detail-value">
                <?php echo e($classSession->section->section_name ?? 'N/A'); ?>
        ...
        <div class="session-detail-card">
            ...
            <div class="session-detail-value">
                ...
                –
                <?php echo e(substr($classSession->end_time ?? '', 0, -3)); ?>
    ...
    <form method="POST" action="<?php echo e(route('staff.attendance.save', $classSession)); ?>">
        ...
        <div class="attendance-actions">
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('staff.attendance.sessions')); ?>" class="btn-secondary">
                    Cancel
                </a>
