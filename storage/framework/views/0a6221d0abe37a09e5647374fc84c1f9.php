...
<?php $__env->startSection('content'); ?>
    <div class="card">
        ...
        <div style="overflow-x:auto;">
            <table class="data-table">
                <thead><tr><th>Course</th><th>Branch</th><th>Section</th><th>Class Date</th><th>Status</th><th>Attendance</th></tr></thead>
                <tbody>
    ...
    <?php
        $isExpired =
            ...
            $feedbackSession->deadline_at < now();
        $badgeColor = 'gray';
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($feedbackSession->status === 'draft'): ?>
                                <a href="<?php echo e(route('staff.feedback.attendance', $feedbackSession)); ?>"
                            ...
                            <?php elseif($feedbackSession->status === 'active'): ?>
                                <div style="font-size:.78rem;color:<?php echo e($isExpired ? '#DC2626' : '#64748B'); ?>;margin-bottom:7px; font-weight: <?php echo e($isExpired ? '600' : 'normal'); ?>;">
                                    ...
                                    <form method="POST"
                                        action="<?php echo e(route('staff.feedback.close', $feedbackSession)); ?>"
                                        onsubmit="return confirm('Close this feedback session?')"
