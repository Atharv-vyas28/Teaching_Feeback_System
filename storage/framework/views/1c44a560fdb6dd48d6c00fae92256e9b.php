...
<div class="card" style="margin-bottom:20px;">
    <div class="card-body" style="display:flex;gap:24px;flex-wrap:wrap;">
        ...
        <div><div style="font-size:0.7rem;color:#94A3B8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:3px;">Topic</div><div style="font-weight:700;color:#0F172A;"><?php echo e($classSession->topic ?? 'N/A'); ?></div></div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="attendance[<?php echo e($student->id); ?>][status]" class="form-select status-select" style="width:130px;" data-student="<?php echo e($student->id); ?>">
                        ...
                        <td>
                            <label style="display:flex;align-items:center;gap:6px;cursor:pointer;">
                                <input type="checkbox"
                                       name="attendance[<?php echo e($student->id); ?>][feedback_enabled]"
                                       value="1"
                                       class="feedback-cb cb-<?php echo e($student->id); ?>"
                                       <?php echo e(($existing && $existing->feedback_enabled) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abhis\Web Dev\Teaching_Feeback_System\resources\views/faculty/attendance/take.blade.php ENDPATH**/ ?>