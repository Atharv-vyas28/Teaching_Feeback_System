...
<?php $__env->startSection('sidebar-nav'); ?> <div class="nav-section-label">Main</div>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="attendance-hero">
        <div class="attendance-hero-top">
            <div>
                <div class="lecture-badge">
                     Lecture <?php echo e($lectureNumber); ?>

                </div>


                <h2>
                    <?php echo e($classSession->section->course->name ?? 'Class Session'); ?>

                </h2>

                <p>
                    <?php echo e($classSession->topic ?? 'No topic specified for this lecture.'); ?>
        ...
        <div class="session-details">
            ...
            <div class="session-detail-card">
                ...
                <div class="session-detail-value">
                    <?php echo e($classSession->session_date->format('M d, Y')); ?>
            ...
            <div class="session-detail-card">
                ...
                <div class="session-detail-value">
                    <?php echo e(substr($classSession->start_time, 0, -3)); ?> – <?php echo e(substr($classSession->end_time, 0, -3)); ?>
            ...
            <div class="session-detail-card">
                ...
                <div class="session-detail-value">
                    <?php echo e($classSession->topic ?? 'N/A'); ?>
    ...
    <div class="attendance-summary">
        <div class="summary-card summary-total">
            ...
            <div>
                ...
                <div class="summary-number"><?php echo e(count($students)); ?></div>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('faculty.attendance.save', $classSession)); ?>">
            <?php echo csrf_field(); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="student-row"
                                data-search="<?php echo e(strtolower($student->name . ' ' . ($student->roll_number ?? ''))); ?>">
                                ...
                                <td>
                                    <input type="hidden" name="attendance[<?php echo e($student->id); ?>][status]"
                                        value="<?php echo e($currentStatus); ?>" class="status-input"
                                        id="status-<?php echo e($student->id); ?>">

                                    <button type="button" id="attendance-btn-<?php echo e($student->id); ?>"
                                        class="attendance-toggle-btn <?php echo e($currentStatus === 'present' ? 'present' : 'absent'); ?>"
                                        onclick="toggleAttendance(<?php echo e($student->id); ?>)">
                                        <?php echo e($currentStatus === 'present' ? '✓ Present' : '✕ Absent'); ?>

                                    </button>
                                </td>

                                <td>
                                    <input type="text" name="attendance[<?php echo e($student->id); ?>][remarks]"
                                        class="form-input" style="width:170px;" value="<?php echo e($existing?->remarks ?? ''); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Atharv Vyas\OneDrive\Desktop\Web Dev\learn\laravel-\resources\views/faculty/attendance/take.blade.php ENDPATH**/ ?>