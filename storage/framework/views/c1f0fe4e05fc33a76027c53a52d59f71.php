...
<?php $header = 'Thank You!'; $subheader = 'Your feedback has been submitted anonymously.'; ?>
...
<div style="max-width:520px;margin:40px auto;text-align:center;">
    ...
    <p style="font-size:0.9rem;color:#64748B;line-height:1.6;margin-bottom:8px;">
        Your feedback for <strong><?php echo e($feedbackSession->classSession->section->course->name ?? 'this course'); ?></strong> has been recorded anonymously.
    </p>
    ...
    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:14px;padding:20px;margin-bottom:28px;text-align:left;">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;">
            <div style="font-size:0.85rem;color:#374151;"><strong>Course:</strong> <?php echo e($feedbackSession->classSession->section->course->name ?? 'N/A'); ?></div>
            <div style="font-size:0.85rem;color:#374151;"><strong>Date:</strong> <?php echo e($feedbackSession->classSession->session_date->format('M d, Y')); ?></div>
            <?php if($feedbackSession->classSession->topic): ?>
            <div style="font-size:0.85rem;color:#374151;"><strong>Topic:</strong> <?php echo e($feedbackSession->classSession->topic); ?></div>
            <?php endif; ?>
        </div>
    </div>

    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
        <a href="<?php echo e(route('student.feedback.index')); ?>" class="btn-primary">View All Feedback</a>
        <a href="<?php echo e(route('student.dashboard')); ?>" class="btn-secondary">Back to Dashboard</a>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Atharv Vyas\OneDrive\Desktop\Web Dev\learn\laravel-\resources\views/student/feedback/confirmation.blade.php ENDPATH**/ ?>