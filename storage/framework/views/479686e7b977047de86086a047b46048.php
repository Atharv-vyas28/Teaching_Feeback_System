...
<div class="card" style="margin-bottom:24px;">
    ...
    <div style="padding:12px 20px 20px;display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:14px;">
        <?php $__empty_1 = true; $__currentLoopData = $courseSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <a
                href="<?php echo e(route('faculty.attendance.sessions', ['section_id' => $section->id])); ?>"
                style="
                    display:block;
                    text-decoration:none;
                    border:1px solid <?php echo e($isSelected ? '#3B82F6' : '#E2E8F0'); ?>;
                    background:<?php echo e($isSelected ? '#EFF6FF' : '#FFFFFF'); ?>;
                    border-radius:10px;
                    padding:16px;
                ...
                <div style="display:flex;justify-content:space-between;gap:12px;">
                    <div>
                        <div style="font-size:0.72rem;font-weight:700;color:#3B82F6;text-transform:uppercase;">
                            <?php echo e($section->course?->code ?? 'Course'); ?>

                        </div>

                        <div style="font-weight:700;color:#0F172A;margin-top:4px;">
                            <?php echo e($section->course?->name ?? 'N/A'); ?>

                        </div>

                        <div style="font-size:0.78rem;color:#64748B;margin-top:3px;">
                            Section <?php echo e($section->section_name); ?>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:18px;">
                    <div style="background:#F8FAFC;border-radius:7px;padding:10px;">
                        ...
                        <div style="font-size:1.05rem;font-weight:700;color:#0F172A;margin-top:3px;">
                            <?php echo e($section->total_sessions); ?>
                    ...
                    <div style="background:#F8FAFC;border-radius:7px;padding:10px;">
                        ...
                        <div style="font-size:1.05rem;font-weight:700;color:#0F172A;margin-top:3px;">
                            <?php echo e($section->total_marked > 0 ? $attendancePercentage . '%' : '—'); ?>
...
<div class="card" style="margin-bottom:24px;">
    ...
    <?php if($attendanceTrend->isNotEmpty()): ?>
...
<div class="card">
    <div style="padding:20px 20px 12px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
        ...
        <?php if($selectedSectionId): ?>
            <a href="<?php echo e(route('faculty.attendance.sessions')); ?>" class="btn-secondary btn-sm">
                View All
            </a>
        <?php endif; ?>
    </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td style="font-size:0.8rem;color:#64748B;">
                            <?php echo e(substr($session->start_time, 0, -3) ?? ''); ?> – <?php echo e(substr($session->end_time, 0, -3) ?? ''); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="5" style="text-align:center;padding:40px;color:#94A3B8;">
                            ...
                            <a href="<?php echo e(route('faculty.attendance.create')); ?>" style="color:#3B82F6;">
                                Create a session →
                            </a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Atharv Vyas\OneDrive\Desktop\Web Dev\learn\laravel-\resources\views/faculty/attendance/sessions.blade.php ENDPATH**/ ?>