<?php $__env->startSection('title', 'Course Sections'); ?>
<?php $header = 'Sections: ' . $course->name; $subheader = 'Manage sections for ' . $course->code; ?>
...
<div style="display:grid;grid-template-columns:1fr 2fr;gap:20px;">
    <div class="card" style="align-self:start;">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.courses.sections.store', $course)); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="font-weight:600;color:#0F172A;">Section <?php echo e($sec->section_name ?? $sec->name); ?></td>
                        <td><?php echo e($sec->semester->name ?? 'N/A'); ?></td>
                        <td><?php echo e($sec->enrollments->count()); ?> / <?php echo e($sec->max_students); ?></td>
                        <td>
                            <span class="badge <?php echo e($sec->is_active ? 'badge-green' : 'badge-gray'); ?>">
                                <?php echo e($sec->is_active ? 'Active' : 'Inactive'); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abhis\Web Dev\Teaching_Feeback_System\resources\views/admin/courses/sections.blade.php ENDPATH**/ ?>