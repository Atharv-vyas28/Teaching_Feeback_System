    ...
    <div class="card" style="align-self:start;">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.staff-assignments.store')); ?>">
                ...
                <div style="margin-bottom:18px;"><label class="form-label">Feedback Session <span style="color:#94A3B8;">(optional)</span></label><select class="form-select" name="feedback_session_id"><option value="">Course/attendance assignment only</option><?php $__currentLoopData = $feedbackSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($feedback->id); ?>">#<?php echo e($feedback->id); ?> — <?php echo e($feedback->classSession->section->course->code ?? 'Course'); ?> — <?php echo e($feedback->classSession->topic ?? 'Class feedback'); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abhis\Web Dev\Teaching_Feeback_System\resources\views/admin/staff-assignments/index.blade.php ENDPATH**/ ?>