...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('faculty.attendance.sessions')); ?>" style="font-size:0.78rem;color:#3B82F6;text-decoration:none;">View all →</a>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('faculty.feedback.my-ratings')); ?>" style="font-size:0.78rem;color:#3B82F6;text-decoration:none;">View all →</a>
        </div>
        <div style="overflow-x:auto;">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span style="font-weight:800;font-size:1rem;color:<?php echo e(($r->overall_weighted_rating ?? 0) >= 4 ? '#1D4ED8' : '#D97706'); ?>;">
                                <?php echo e($r->overall_weighted_rating ? number_format($r->overall_weighted_rating,1) : '—'); ?>

                            </span>
                            <?php if($r->overall_weighted_rating): ?><span style="color:#94A3B8;font-size:0.75rem;">/5</span><?php endif; ?>
                        </td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abhis\Web Dev\Teaching_Feeback_System\resources\views/faculty/dashboard.blade.php ENDPATH**/ ?>